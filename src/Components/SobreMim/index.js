    ...
    return (
        <section id='section-sobre' className="Secao2">
            <div className="SobreMim">
                ...
                <p>Atualmente, continuo estudando Node e me aprofundando em conceitos da computação. Pretendo continuar aprendendo e explorar outras linguagens e frameworks, tenho grande interesse em linguagens como C#, Kotlin e Python.
                </p>
            </div>
