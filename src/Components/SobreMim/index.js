...
<section id='section-sobre' className="Secao2">
    <div className="SobreMim">
        <h1>Mais Sobre Mim</h1>
            <p>Meu nome é Matheus, tenho 17 anos e nasci em Barueri, porém sempre morei em São Paulo. Desde jovem, sempre fui apaixonado por tecnologia, com interesse constante em celulares, computadores, e assim por diante. Inicialmente, criei interesse pelo desenvolvimento de jogos, porém mudei de ideia quando comecei a lidar com o Desenvolvimento Web, pelo qual criei maior curiosidade.
